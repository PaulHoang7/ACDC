"""M2: AttUNetR34 — U-Net with attention gates on skip connections."""
...
class AttUNetR34(nn.Module):
    """
    Attention U-Net with ResNet34 encoder.
    Attention gates on skip connections, no boundary head, no deep supervision.
